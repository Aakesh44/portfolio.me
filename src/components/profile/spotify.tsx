...
const Spotify = () => {
    ...
    const {data} = useSWR<Song>("/api/now-playing/", fetcher, { revalidateOnFocus: false });
    console.log(data);
            ...
            <div className='flex items-center gap-4'>
                ...
                {data?.isPlaying && (
                    <>
                        ...
                        <div className='relative shrink-0 bg-background size-8 rounded-full spin-in animate-spin duration-75 overflow-hidden'>
                            <Image
